...
#define AMG88xx_PIXEL_MIRROR true // this changes left to righ to righ to left for things such as pointers where display is in opposite direction of sensor
//#define I2C_DEBUG 
