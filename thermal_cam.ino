...
#if subpixelcoloroptimized == true //this is for writing 4 rectangles at a time!
...
#if subpixelcoloroptimized == false  //this means we write every single time to display
int tempint=interpolateSampleDir*4;//we reuse so calculate one time
...
#if subpixelcoloroptimized == true //we finish write update to display
