...
//#define spi_optimized_st77xx false to true, this will optimize spi to burst 2x as fast
//#define subpixelcoloroptimized 0 to 1 or 2, this will allow muliple writes at a time 4x-16x speed
//#define colorMode 0 to 1,2,21,22 for more color ranges.
//
...
/***************************************************************************
  This is a library for the AMG88xx GridEYE 8x8 IR camera//this is better with included zip package that has all needed libraries in it for testing.
//most updated version of thermal_cam file can replace the one in zip file
//this is a work in process. 16x16 subsample seems to work ok, trying to verify 32x32 and add up to 512 by 512
//some changes may be needed to have includes location changes also spixx.h just uses libray in file change back to <spi.h>
...
#define temp_Fahrenhei false //we convert output temp to F, otherwise it is c
//***********************************
...
#define spi_optimized_st77xx false  //false if using normal driver//these files are upaded and specific for this code needed st77xx,h, st77xx.cpp need downloaded from https://github.com/jamesdanielv/thermalcam/blob/master/colorgenerator
