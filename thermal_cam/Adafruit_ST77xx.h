 ...
 ****************************************************/
//#define spibufferpoll true //this allows spi to buffer and write data while running other code, this is not a interupt buffer but a polling method. should boost by another 100%
 ...
 public:
  ...
  void     setAddrWindow(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1),
           ...
           fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
             uint16_t color),
           BufferSPIWRITE(uint8_t data),
           BufferSPISEND(),
           fillRectFast(int16_t x, int16_t y, int16_t w, int16_t h,
             uint16_t color),
           fillRectFast4colors(int16_t x, int16_t  y, uint8_t  w, uint8_t   h,
           ...
           fillRectFast16colors(int16_t x, int16_t y, int16_t  w,int16_t   h,
                                uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3),
            fillRectFast16colors1(uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7),
            fillRectFast16colors2( uint16_t color8, uint16_t color9, uint16_t color10, uint16_t color11),
            fillRectFast16colors3( uint16_t color12, uint16_t color13, uint16_t color14, uint16_t color15),
           ...
           fillRectFast64color(uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7),
           fillRectFast64colorEnd(),
           fillRectFast64FiltercolorStart(int16_t x, int16_t y, int16_t w, int16_t h,
             uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7),
           fillRectFast64Filtercolor(uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7),  
             fillRectFast64FiltercolorEnd(),
             fillRectFast256colorStart(int16_t x, int16_t y, int16_t w, int16_t h,
             uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7,
           ...
           fillRectFast256color( uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7,
             uint16_t color8, uint16_t color9, uint16_t color10, uint16_t color11,
             uint16_t color12, uint16_t color13, uint16_t color14, uint16_t color15),
             fillRectFast256colorEnd(),                                                   
