#include "AaSensorMode.h" //this file tells us what sensor to use
#if Sensor_mode == 0 
#include "Adafruit_AMG88xx.h"
#define wireClockSpeed 400000 //10000,1000000,400000,1000000
#define AMG88xx_PIXEL_MIRROR true // this changes left to right to right to left for things such as pointers where display is in opposite direction of sensor
//#define I2C_DEBUG 
...
#if AMG88xx_PIXEL_MIRROR == false
     buf[i]=converted;  //unflipped
#endif

#if AMG88xx_PIXEL_MIRROR == true
//we convert to row and colum info, and invert the columb data@
     buf[(7-(i/8))*8+(i-(i/8)*8)]=converted;  //flipped
#endif
