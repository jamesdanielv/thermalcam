...
#define _ADAFRUIT_SPITFT_
 ...
 #include "WProgram.h"
#endif
#include "Adafruit_GFX_ili9341.h"
...
class Adafruit_SPITFT : public Adafruit_GFX {
	...
	*/
	...
	void      pushColor(uint16_t color);
        ...
        void      fillRectbarline(int16_t x, int16_t y,int16_t w, int16_t h,uint16_t color); 
        void      ScreenFast(int16_t x, int16_t y, int16_t w, int16_t h,uint16_t color);
        void      fillRectFastHalf(int16_t x, int16_t y, int16_t w, int16_t h,uint16_t color);
        void      fillRectFast4colors(int16_t  x, int16_t y, uint16_t  w, uint16_t  h, uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast4colorsHalf(int16_t  x, int16_t y, uint16_t  w, uint16_t  h, uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors(   uint16_t  x, uint16_t y, uint16_t w, uint16_t h, uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors1( uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors2( uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors3( uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast64colorStart(int16_t x, int16_t y, int16_t  w, int16_t   h,
        ...
        void      fillRectFast64color(uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
                  uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7);
        void      fillRectFast64colorEnd();
        void      fillRectFast64colorStartHalf(int16_t x, int16_t y, int16_t  w, int16_t   h,
                  uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
                  uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7);
        void      fillRectFast64colorHalf(uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
                  uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7);
        void      fillRectFast64colorEndHalf();        
        void      fillRectFast16colorsHalf(   uint16_t  x, uint16_t y, uint16_t w, uint16_t h, uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors1Half( uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors2Half( uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast16colors3Half( uint16_t color0,uint16_t color1,uint16_t color2,uint16_t color3);
        void      fillRectFast256colorStart(int16_t x, int16_t y, int16_t w, int16_t h,
             uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7,
        ...
        void  fillRectFast256color( uint16_t color0, uint16_t color1, uint16_t color2, uint16_t color3,
             uint16_t color4, uint16_t color5, uint16_t color6, uint16_t color7,
             uint16_t color8, uint16_t color9, uint16_t color10, uint16_t color11,
             uint16_t color12, uint16_t color13, uint16_t color14, uint16_t color15);
        void     fillRectFast256colorEnd();    
